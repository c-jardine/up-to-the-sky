...
const Obituary = () => {
  return (
    <>
      <NextSeo
        title="Kristin Renee Cantrell Hill"
        description="HILL, Kristin Renee (Cantrell) age 43 of Fairfield passed away Monday, December 7, 2020 in Hospice of Hamilton. She was born November 19, 1977 in Hamilton..."
        canonical="https://www.uptothesky.org/obituary"
      />
      <Stack maxW="4xl" mx="auto" my={16} px={4}>
        ...
        <Stack spacing={8} pt={8}>
          ...
          <Text>
            ...
            was primarily with TriHealth which ended as a Substance Use
            Treatment RN for TriHealth at Good Samaritan and Bethesda North
            hospitals. Kristin had the ability to touch so many lives as anyone
            who knew her and worked with her had stated so often during her
            illness.
          </Text>
          <Text>
          ...
          <Text>
            ...
            Saturday in Sacred Heart Church, 400 Nilles Rd. Fairfield, Ohio
            45014, with Fr. Larry Tharp celebrant.
          </Text>
          <Text>
            Visitation will be from 10:00-11:00am Saturday in the Church
            Narthex. Memorials are suggested to Brain Cancer Research. Online
