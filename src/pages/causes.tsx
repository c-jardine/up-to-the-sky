...
const DiagnosisPage = () => {
  return (
    <>
      <NextSeo
        title="Glioblastoma causes"
        description="The exact cause of glioblastoma is not known. Some risk factors may make someone more likely to develop high-grade gliomas like glioblastoma. Click to learn more."
        canonical="https://www.uptothesky.org/causes"
      />
          ...
          <Stack mt={4} color="blackAlpha.800" fontSize="xl">
            <Stack spacing={8}>
              <Stack>
                ...
                <Text>
                  Exposure to ionizing radiation as a result of radiation
                  therapy for childhood brain tumors or leukemia is a risk
                  factor for high-grade gliomas like glioblastoma.
                </Text>
              </Stack>
              <Stack>
                <Heading as="h3" fontSize="2xl">
              ...
              <Stack>
                ...
                <Text>
                  Glioblastomas can occur at any age but are more common in
                  older patients between the ages of 65 and 74. The median age
                  of a glioblastoma diagnosis is 65.
                </Text>
                <Text>
